...
then
    ...
    find -mindepth 1 -type f -iname '*.log.gz' -exec rm -f {} \;
    find -mindepth 1 -type f -iname '*.db' -exec rm -f {} \;
    ...
    find -mindepth 1 -type f -iname '*.log.gz' -exec rm -i {} \;
    find -mindepth 1 -type f -iname '*.db' -exec rm -i {} \;
